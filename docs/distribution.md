...
| npm                   | Live   | `@basicbit/vrchat-mcp`                           | Latest verified release: `0.1.9`.                                      |
| Official MCP Registry | Live   | `io.github.BASIC-BIT/vrchat-mcp`                 | Latest verified release: `0.1.9`; package entry points to npm `0.1.9`. |
| GitHub Releases       | Live   | https://github.com/BASIC-BIT/vrchat-mcp/releases | Latest verified release: `v0.1.9`.                                     |
