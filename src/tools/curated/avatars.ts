  ...
  server.registerTool(
    toolName('vrchat.avatar.update'),
    {
      description: [
        ...
        'before changing it. Going public can expose a creator’s work against their terms, can',
        'leak an avatar that was meant to stay private, and may breach VRChat’s content policy',
        'depending on what the avatar contains. Going private breaks the avatar for everyone',
        'currently wearing it, who will find it gone at next login. Use dryRun to preview the',
        'exact change first.',
      ].join(' '),
