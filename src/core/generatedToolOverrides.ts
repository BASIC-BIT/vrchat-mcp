...
const CURATED_WRITE_TOOL_MAP = new Map<string, string>([
  ...
  ['addGroupPost', toToolName('vrchat.group.post.create')],
  ['updateGroupPost', toToolName('vrchat.group.post.update')],
  ['deleteGroupPost', toToolName('vrchat.group.post.delete')],
