...
const GroupPostsResponse = z.object({ posts: z.array(GroupPost) }).passthrough();
...
const PaginatedCalendarEventList = z
  .object({ results: z.array(CalendarEvent), totalCount: z.number().int(), hasNext: z.boolean() })
  .passthrough();
